        ...
        <table id="example" class="display table table-striped" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if ($item->foto==null)
                        <a class="text-danger" data-toggle="modal" data-target=".bd-example-modal-md-{{$item->id_usuario}}"
                            href="">Agregar</a>
                        @else
                        <a data-toggle="modal" data-target=".bd-example-modal-md-{{$item->id_usuario}}"
                            href="">Ver foto</a>
                        @endif
                    </td>
                    <td>

                        <a style="top: 0" href="{{route('usuario.edit',$item->id_usuario)}}" class="btn btn-sm btn-warning m-1"><i
